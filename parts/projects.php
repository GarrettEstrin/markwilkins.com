<section class="section section--black mainview projects" id="jsProjects" vs-anchor="jsProjects">
  <div class="container">
    ...
    <div class="projects__cont" onClick="playVideo(this)" data-video='<iframe src="https://player.vimeo.com/video/157377443" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'>
      <div class="projects__play"></div>
    </div>
    ...
    <div class="projects__cont project__cont--mobile"  onClick="playVideo(this)" data-video='<iframe src="https://player.vimeo.com/video/189711531" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'>
      <div class="projects__play"></div>
    </div>
    <div class="projects__cont project__cont--mobile"  onClick="playVideo(this)" data-video='<iframe src="https://player.vimeo.com/video/157370850" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'>
      <div class="projects__play"></div>
    </div>
  </div>
  <script>
